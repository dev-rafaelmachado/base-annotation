...
class TerminalUI:
    ...
    def print_instructions(self):
        ...
        print("- ROTAÇÃO: [ N ] ← 10° | [ M ] → 10° | [ T ] resetar")
        print("- Digite a data:")
        print("  • Com dia: 01/02/2025 ou 01022025 ou 010225")
        print("  • Sem dia: 02/2025 ou 022025 ou 0225 (assume ÚLTIMO dia)")
        print("    Ex: 02/2025 → 2025-02-28 (ou 29 se bissexto)")
        print("  (será salva como: YYYY-MM-DD)")
